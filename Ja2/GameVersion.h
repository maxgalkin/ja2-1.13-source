...
#define			BELIEF_STORE_IN_SAVE							187 // ja2mod 2026-09-15: the neural AI's per-observer belief store is appended after the rebel command data (ModularizedTacticalAI/NeuralHooks.cpp SaveNeuralState). Older saves load with an empty store.
...
#define			SAVE_GAME_VERSION								BELIEF_STORE_IN_SAVE	// ja2mod
